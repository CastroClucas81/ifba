    ...
    <div class="columns">
        <div class="column is-12">
            <div class="box">
                ...
                @if (session('successDeletarDocumento'))
                <div class="notification is-success">
                    <button class="delete"></button>
                    {{ session('successDeletarDocumento') }}
                </div>
                @elseif (session('errorDeletarDocumento'))
                <div class="notification is-danger">
                    <button class="delete"></button>
                    {{ session('errorDeletarDocumento') }}
                </div>
                @endif
...
<div id="modal-fadeInScale-fs" class="modal modal-fx-fadeInScale">
    ...
    <div class="modal-content modal-card">
        ...
        <footer class="modal-card-foot">
            <form action="{{ route('documento.delete') }}" method="post">
                @csrf
