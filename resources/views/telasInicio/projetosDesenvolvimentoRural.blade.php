    ...
    <div class="columns">
        <div class="column is-12">
            <div class="box">
                ...
                @if (session('successDeletarProjetosDesenvolvimentoRural'))
                <div class="notification is-success">
                    <button class="delete"></button>
                    {{ session('successDeletarProjetosDesenvolvimentoRural') }}
                </div>
                @elseif (session('errorDeletarProjetosDesenvolvimentoRural'))
                <div class="notification is-danger">
                    <button class="delete"></button>
                    {{ session('errorDeletarProjetosDesenvolvimentoRural') }}
                </div>
                @endif
                ...
                <div class="columns">
                    <div class="column is-half is-offset-one-quarter">
                        <div class="notification is-primary">
                            Não há projetos de desenvolvimento rural publicados.
                        </div>
                    </div>
                </div>
                @endif
...
<div id="modal-fadeInScale-fs" class="modal modal-fx-fadeInScale">
    ...
    <div class="modal-content modal-card">
        ...
        <footer class="modal-card-foot">
            <form action="{{ route('ProjetosDesenvolvimentoRural.delete') }}" method="post">
                @csrf
