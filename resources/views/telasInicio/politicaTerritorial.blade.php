    ...
    <div class="columns">
        <div class="column is-12">
            <div class="box">
                ...
                @if (session('successDeletarPoliticaTerritorial'))
                <div class="notification is-success">
                    <button class="delete"></button>
                    {{ session('successDeletarPoliticaTerritorial') }}
                </div>
                @elseif (session('errorDeletarPoliticaTerritorial'))
                <div class="notification is-danger">
                    <button class="delete"></button>
                    {{ session('errorDeletarPoliticaTerritorial') }}
                </div>
                @endif
                ...
                <div class="column is-half is-offset-one-quarter">
                    <div class="notification is-primary">
                        Não há Políticas territoriais publicadas.
                    </div>
                </div>
                @endif
            </div>
...
<div id="modal-fadeInScale-fs" class="modal modal-fx-fadeInScale">
    ...
    <div class="modal-content modal-card">
        ...
        <footer class="modal-card-foot">
            <form action="{{ route('municipios.edit') }}" method="post">
                @csrf
