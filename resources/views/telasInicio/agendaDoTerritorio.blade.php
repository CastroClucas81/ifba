    ...
    <div class="columns">
        <div class="column is-12">
            <div class="box">
                ...
                @if (session('successDeletarAgendaDoTerritorio'))
                <div class="notification is-success">
                    <button class="delete"></button>
                    {{ session('successDeletarAgendaDoTerritorio') }}
                </div>
                @elseif (session('errorDeletarAgendaDoTerritorio'))
                <div class="notification is-danger">
                    <button class="delete"></button>
                    {{ session('errorDeletarAgendaDoTerritorio') }}
                </div>
                @endif
...
<div id="modal-fadeInScale-fs" class="modal modal-fx-fadeInScale">
    ...
    <div class="modal-content modal-card">
        ...
        <footer class="modal-card-foot">
            <form action="{{ route('agendaDoTerritorio.delete') }}" method="post">
                @csrf
