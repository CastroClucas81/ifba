    ...
    <div class="columns">
        <div class="column is-12">
            <div class="box">
                ...
                @if (session('successDeletarNucleoDiretiro'))
                <div class="notification is-success">
                    <button class="delete"></button>
                    {{ session('successDeletarNucleoDiretivo') }}
                </div>
                @elseif (session('errorDeletarNucleoDiretivo'))
                <div class="notification is-danger">
                    <button class="delete"></button>
                    {{ session('errorDeletarNucleoDiretivo') }}
                </div>
                @endif
...
<div id="modal-fadeInScale-fs" class="modal modal-fx-fadeInScale">
    ...
    <div class="modal-content modal-card">
        ...
        <footer class="modal-card-foot">
            <form action="{{ route('nucleoDiretivo.delete') }}" method="post">
                @csrf
