...
<div class="container is-fluid">
    <div class="columns">
        <div class="column is-12">
            <div class="box">
                <p class="modal-card-title">Caracterização e histórico</p>
                <hr>

                @if (session('successDeletarCaracterizacaoHistorico'))
                <div class="notification is-success">
                    <button class="delete"></button>
                    {{ session('successDeletarCaracterizacaoHistorico') }}
                </div>
                @elseif (session('errorDeletarCaracterizacaoHistorico'))
                <div class="notification is-danger">
                    <button class="delete"></button>
                    {{ session('errorDeletarCaracterizacaoHistorico') }}
                </div>
                @endif
...
<div id="modal-fadeInScale-fs" class="modal modal-fx-fadeInScale">
    ...
    <div class="modal-content modal-card">
        ...
        <footer class="modal-card-foot">
            <form action="{{ route('caracterizacaoHistorico.delete') }}" method="post">
                @csrf
